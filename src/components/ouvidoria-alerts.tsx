    ...
    return (
      <Card className="border-emerald-500/30 bg-card shadow-sm">
        <CardContent className="p-3 flex items-center gap-2.5">
          ...
          <div>
            <h4 className="text-xs font-semibold text-slate-900 dark:text-slate-100">Tudo sob controle</h4>
            <p className="text-[11px] text-slate-700 dark:text-slate-400">Nenhum ponto crítico ou alerta operacional ativo no momento.</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className="space-y-2.5">
      <div className="flex items-center justify-between">
        <h3 className="text-[11px] font-semibold uppercase tracking-wider text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
          <ShieldAlert className="h-3.5 w-3.5 text-primary" />
          Sistema Inteligente de Alertas & Monitoramento
        </h3>
        <span className="text-[11px] font-medium text-slate-600 dark:text-slate-400 bg-slate-200/80 dark:bg-slate-700/60 px-2 py-0.5 rounded-full">
          ...
          return (
            ...
            >
              <CardContent className="p-3.5 space-y-2">
                ...
                {alerta.detalhes && (
                  <div className="pt-1.5 border-t border-border/50 text-[10px] text-slate-600 dark:text-slate-400 flex items-start gap-1">
