...
const STATUS_BADGE: Record<string, { label: string; cls: string }> = {
  "No Prazo":       { label: "No Prazo",     cls: "bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-500/15 dark:text-emerald-300 dark:border-emerald-500/30" },
  "Fora do Prazo":  { label: "Fora Prazo",   cls: "bg-red-100    text-red-700    border-red-200 dark:bg-red-500/15 dark:text-red-300 dark:border-red-500/30"   },
  "Em Andamento":   { label: "Andamento",    cls: "bg-blue-100   text-blue-700   border-blue-200 dark:bg-blue-500/15 dark:text-blue-300 dark:border-blue-500/30"  },
  "Concluido":      { label: "Concluído",    cls: "bg-slate-100  text-slate-600  border-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:border-slate-700" },
};
